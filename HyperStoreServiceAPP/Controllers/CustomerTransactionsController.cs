...
namespace HyperStoreServiceAPP.Controllers
{
    public class CustomerTransactionsController : ApiController, ICustomerTransaction
    {
        ...
        [HttpGet]
        public async Task<IHttpActionResult> Get(Guid userId, CustomerTransactionFilterCriteria transactionFilterCriteria)
        {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Post(Guid userId, CustomerTransactionDTO transactionDTO)
        {
